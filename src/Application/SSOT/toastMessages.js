...
export const recipeOnUseSuccess = "Fridge content updated";
export const recipeOnUseError = "Something went wrong";
...
export const invitingUserSuccess = "If the user exists, he has been invited";
export const invitingUserError = "Couldn't invite user";

export const productsAddedToFridgeSuccess = "Products were added to the fridge";
export const productsAddedToFridgeError =
  "Products couldn't be added to the fridge";

export const copyShoppingListInfo = "Shopping list copied!";
